...
const Product = ({ post }) => {
  ...
  return (
    <div className=" flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in gap-3 py-4 mt-10 ml-5 rounded-xl outline">
      <div>
      ...
      <div className="h-[180px]">
        <img src={post.images} className="h-full w-full" />
      </div>
